    ...
    return (
        <section className="add-to-cart">
            <div className="add-to-cart_increment">
                <button onClick={decrementOrderNumberHandler} className="add-to-cart_increment-btn"><img src={minus} alt="" /></button>
                {orderNumber}
                <button onClick={incrementOrderNumberHandler} className="add-to-cart_increment-btn"><img src={plus} alt="" /></button>
            </div>
